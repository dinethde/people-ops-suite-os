...
import { CreateEmployeeFormValues, emptyCreateEmployeeValues } from "@root/src/types/types";
...
const OrangeConnector = styled(StepConnector)(({ theme }) => ({
  ...
  [`&.${stepConnectorClasses.active}`]: {
    [`& .${stepConnectorClasses.line}`]: {
      backgroundImage: "linear-gradient(90deg, #ff7300, rgba(255, 115, 0, 0.5))",
    },
  },
...
export default function Employees() {
  ...
  const handleFormSubmit = (formData: CreateEmployeePayload, resetForm: () => void) => {
    showConfirmation(
          ...
          onSubmit={async (values: CreateEmployeeFormValues, actions) => {
            if (activeStep === EmployeeFormSteps.length - 1) {
              const payload: CreateEmployeePayload = {
                ...
                subTeamId: values.subTeamId && values.subTeamId > 0 ? values.subTeamId : undefined,
                businessUnitId: values.businessUnitId,
                unitId: values.unitId && values.unitId > 0 ? values.unitId : undefined,
                ...
                personalInfo: {
                  ...
                  nameWithInitials: values.personalInfo.nameWithInitials || undefined,
                  ...
                  residentNumber: values.personalInfo.residentNumber || undefined,
                  ...
                  stateOrProvince: values.personalInfo.stateOrProvince || undefined,
            ...
            >
              ...
              >
                ...
                <Button
                  ...
                  endIcon={activeStep === EmployeeFormSteps.length - 1 ? null : <ArrowForward />}
                  onClick={async () => {
