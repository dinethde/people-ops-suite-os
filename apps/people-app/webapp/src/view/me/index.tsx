...
import { FieldArray, Form, Formik, FormikErrors, FormikHandlers, FormikValues } from "formik";
...
export default function Me() {
  ...
  const personalInfoSchema = object().shape({
    ...
    emergencyContacts: array()
      .of(
        object().shape({
          name: string().nullable().max(100, "Name must be at most 100 characters"),
          relationship: string().nullable().max(50, "Relationship must be at most 50 characters"),
          telephone: string()
            .nullable()
            .matches(/^[0-9+\-()\s]*[0-9][0-9+\-()\s]*$/, "Invalid phone number format"),
          mobile: string()
              ...
              {({ values, handleChange, handleBlur, errors, touched, dirty, resetForm }) => (
                <Form>
                  <Grid container rowSpacing={1.5} columnSpacing={3} pt={2}>
                    ...
                    <Grid item xs={12} sm={6} md={3}>
                      <ReadOnly label="Name with Initials" value={values.nameWithInitials} />
                    </Grid>
                  </Grid>
                  <Grid container rowSpacing={1.5} columnSpacing={3} mt={0.5}>
                    <Grid item xs={12} sm={6} md={3}>
                                ...
                                >
                                  <Grid item xs={12} sm={3}>
                                    <TextField
                                      ...
                                      disabled={isSavingChanges}
                                      error={
                                        (touched.emergencyContacts as any)?.[index]?.name &&
                                        Boolean((errors.emergencyContacts as any)?.[index]?.name)
                                      }
                                      helperText={
                                        (touched.emergencyContacts as any)?.[index]?.name &&
                                        (errors.emergencyContacts as any)?.[index]?.name
                                      }
                                    />
                                  </Grid>
                                  <Grid item xs={12} sm={3}>
                                    <TextField
                                      ...
                                      disabled={isSavingChanges}
                                      error={
                                        (touched.emergencyContacts as any)?.[index]?.relationship &&
                                        Boolean(
                                          (errors.emergencyContacts as any)?.[index]?.relationship,
                                        )
                                      }
                                      helperText={
                                        (touched.emergencyContacts as any)?.[index]?.relationship &&
                                  ...
                                  <Grid item xs={12} sm={2.5}>
                                    <TextField
                                      ...
                                      disabled={isSavingChanges}
                                      error={
                                        (touched.emergencyContacts as any)?.[index]?.telephone &&
                                        Boolean(
                                          (errors.emergencyContacts as any)?.[index]?.telephone,
                                        )
                                      }
                                      helperText={
                                        (touched.emergencyContacts as any)?.[index]?.telephone &&
                                  ...
                                  <Grid item xs={12} sm={2.5}>
                                    <TextField
                                      ...
                                      disabled={isSavingChanges}
                                      error={Boolean(
                                        (touched.emergencyContacts as any)?.[index]?.mobile &&
                                        (errors.emergencyContacts as any)?.[index]?.mobile,
                                      )}
                                      helperText={
                                        (touched.emergencyContacts as any)?.[index]?.mobile &&
                                        (errors.emergencyContacts as any)?.[index]?.mobile
                                    ...
                                    >
                                      <span>
                                        <IconButton
                                          ...
                                          size="small"
                                          onClick={() => {
                                            if ((values.emergencyContacts?.length ?? 0) <= 1) {
                                              return;
                                            }
                                            remove(index);
                                          }}
